...
<body>
  ...
  <div class="card">
    ...
    <input id='task-id-to-delete' placeholder='Ej: 1'>
    <button onclick='deleteTask()' style="background: #f44336;">Eliminar Tarea</button>
  ...
  <div class="card">
    ...
    <input id='user-id-to-delete' placeholder='Ej: 1'>
    <button onclick='deleteUser()' style="background: #f44336;">Eliminar Usuario</button>
...
function deleteTask() {
  const task_id = document.getElementById('task-id-to-delete').value;
  fetch(`http://localhost:5002/tasks/${task_id}`, {
    ...
    verTareas(); // Refresh the list
  });
}

function deleteUser() {
  const user_id = document.getElementById('user-id-to-delete').value;
