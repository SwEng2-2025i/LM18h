...
@service_b.route('/tasks/<int:task_id>', methods=['GET']) # endpoint GET /tasks/<id>  (para verificar que ya no existe)
...
@service_b.route('/tasks/<int:task_id>', methods=['DELETE']) # endpoint DELETE /tasks/<id>
