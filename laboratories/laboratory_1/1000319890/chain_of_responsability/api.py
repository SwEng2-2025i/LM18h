...
class NotificationStats(Resource):
    """
    Resource for retrieving notification statistics.
    """
    ...
    def get(self):
        ...
        description: Returns statistics about notification delivery success rates by channel
        responses:
          200:
            ...
            schema:
              ...
              properties:
                ...
                total_attempts:
                  type: integer
                  description: Total delivery attempts made
        """
        ...
        for channel in VALID_CHANNELS:
            channel_attempts = [h for h in notification_history if h['channel'] == channel]
            channel_successes = [h for h in channel_attempts if h['success']]
            channel_stats[channel] = {
                'total_attempts': len(channel_attempts),
                'successful_attempts': len(channel_successes),
                'success_rate': (len(channel_successes) / len(channel_attempts) * 100) if channel_attempts else 0
            }
...
def home():
    ...
    """
    return """
    <h1>Flask REST API with Chain of Responsibility</h1>
    <h2>Documentation</h2>
    <ul>
    ...
    <ul>
        ...
        <li><strong>GET/POST</strong> <a href="/notifications/send">/notifications/send</a> - Send notifications</li>
